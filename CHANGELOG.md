...
* 67.0 release ([3dc42b8](https://github.com/bit-cook/gpt-computer-assistant/commit/3dc42b81c37af8e42bfdb4f3cabb1e5d3fdbbf11))
* 67.0 release ([aaa0ed7](https://github.com/bit-cook/gpt-computer-assistant/commit/aaa0ed76b3b2ba77f3eceafa0e77a686b7153ec7))
* add anonymization debug panel for enhanced logging ([a38ea73](https://github.com/bit-cook/gpt-computer-assistant/commit/a38ea738cc2d9aa064e6a0aa2810ad68346a59da))
* add asqav governance integration ([9ac7645](https://github.com/bit-cook/gpt-computer-assistant/commit/9ac76456ec1d2773905b323df190d82f702a384d))
* add asqav governance integration for tamper-evident audit trails ([df453bb](https://github.com/bit-cook/gpt-computer-assistant/commit/df453bba4b225724f508de6423ccecde819c374b))
* add comprehensive benchmark system for performance analysis ([#511](https://github.com/bit-cook/gpt-computer-assistant/issues/511)) ([78eada8](https://github.com/bit-cook/gpt-computer-assistant/commit/78eada81c96f88c96dae3c7f940bd393accf104a))
* add directories to .gitignore for autonomous workspace and example ([77ce3fa](https://github.com/bit-cook/gpt-computer-assistant/commit/77ce3fa8005e51a0b6825ea2c06e428820339aac))
* add Examples repository as a git submodule ([d07db67](https://github.com/bit-cook/gpt-computer-assistant/commit/d07db672ba54cdf9b13e05c124c9c103deab405d))
* add Examples repository as a git submodule ([8c824be](https://github.com/bit-cook/gpt-computer-assistant/commit/8c824be904ea60063dac033a55777e78c8bdc07f))
* add mem0ai dependency and update protobuf version ([0e902c5](https://github.com/bit-cook/gpt-computer-assistant/commit/0e902c55c19656d77454066c5c0d20b40fcbedd7))
* add mem0ai dependency and update protobuf version ([1e75d73](https://github.com/bit-cook/gpt-computer-assistant/commit/1e75d73789f61ce8119ec63d12af34e986a28dfd))
* add new skills and system prompt for applied scientist experiments ([87f6573](https://github.com/bit-cook/gpt-computer-assistant/commit/87f6573707b3c0e9b4552e76398005f4da032ca9))
* add printings for ocr modules and missing packages ([987b541](https://github.com/bit-cook/gpt-computer-assistant/commit/987b541ff699ce894d47098febf8ecfcdc9090a2))
* add task_start method to MockTask class for improved testing ([ba6bd54](https://github.com/bit-cook/gpt-computer-assistant/commit/ba6bd54c2474b41049e5eabe9ed3195f7ed5728f))
* add temp directory to .gitignore ([e567d50](https://github.com/bit-cook/gpt-computer-assistant/commit/e567d507ef83863496edc34c238d5fbdb9d03df4))
* add timeout and partial result handling in Agent execution ([c8e3da0](https://github.com/bit-cook/gpt-computer-assistant/commit/c8e3da0693cde60563ffca9f38513672cd770648))
* add timeout and partial result handling in Agent execution ([13940a6](https://github.com/bit-cook/gpt-computer-assistant/commit/13940a699a0e9666ad0da2db3c264a3e4d122b59))
* add token usage recording for tasks in Agent ([717c06a](https://github.com/bit-cook/gpt-computer-assistant/commit/717c06adaf8c56caaad40cf5511bdff88a5d74a7))
* Added deepseek-ocr with ollama ([4e3f1e2](https://github.com/bit-cook/gpt-computer-assistant/commit/4e3f1e22c981acc2c19269b1f1ddfd19be4e38b6))
* Added deepseek-ocr with ollama ([782a452](https://github.com/bit-cook/gpt-computer-assistant/commit/782a452daf704c39beecd4cfad6c3523f23c1ed6))
* added prebuilt agent, AppliedScientist ([#568](https://github.com/bit-cook/gpt-computer-assistant/issues/568)) ([6585088](https://github.com/bit-cook/gpt-computer-assistant/commit/65850886353dde56416a8ccb6e7dfc28a5d25e40))
* Added timeout mechanism to deepseec-ocr ollama ([89dd752](https://github.com/bit-cook/gpt-computer-assistant/commit/89dd752df391c54b39b1276256a39f495da128d5))
* adding load_dotenv ([f83b36c](https://github.com/bit-cook/gpt-computer-assistant/commit/f83b36c6d57a26ce58170afc75b322f6f6330f98))
* Agent/Team as mcp tool, Team can be put inside Team ([17656e2](https://github.com/bit-cook/gpt-computer-assistant/commit/17656e2a217dc0c9fd1055737105c417dbe11bac))
* Agent/Team as mcp tool, Team can be put inside Team ([e6299e4](https://github.com/bit-cook/gpt-computer-assistant/commit/e6299e4e3a7138ece7c9d52c46425234f6505eff))
* **agent:** add cost property ([#579](https://github.com/bit-cook/gpt-computer-assistant/issues/579)) ([14363e0](https://github.com/bit-cook/gpt-computer-assistant/commit/14363e0ad5da42715631257a5cdb09fc46e3f882))
* AppliedScientist accepts any research_source + auto inputs ([#571](https://github.com/bit-cook/gpt-computer-assistant/issues/571)) ([fad994d](https://github.com/bit-cook/gpt-computer-assistant/commit/fad994d27da2d06ea45bc2faaff0f6211aa105b7))
* Auto model, console printing  adding, new policies ([8b0b920](https://github.com/bit-cook/gpt-computer-assistant/commit/8b0b92026d3a1961c0aaf2e9a10233c4f696ec38))
* Auto model, console printing  adding, new policies ([fb3f85e](https://github.com/bit-cook/gpt-computer-assistant/commit/fb3f85e37b83b0c13946481996bf27893177008f))
* chat class, package grouping, import error handling ([473a49a](https://github.com/bit-cook/gpt-computer-assistant/commit/473a49a1bd9abdea26d323d9cc651cba9392ec40))
* **ci:** introduce automated release pipeline ([#589](https://github.com/bit-cook/gpt-computer-assistant/issues/589)) ([#590](https://github.com/bit-cook/gpt-computer-assistant/issues/590)) ([15faa20](https://github.com/bit-cook/gpt-computer-assistant/commit/15faa205d0a922f309f014e5ec3899ed4c11ea22))
* clanker type alias ([02fa626](https://github.com/bit-cook/gpt-computer-assistant/commit/02fa62641ef0f377cf4051b8752115f95b731077))
* clanker type alias ([5b640da](https://github.com/bit-cook/gpt-computer-assistant/commit/5b640da25b23287cb5d0388fb29a623c6eb4721e))
* CLI support for upsonic ([d52c2ee](https://github.com/bit-cook/gpt-computer-assistant/commit/d52c2ee918df79ad55fb4455d0e2dba2e5079bd9))
* CLI support for upsonic ([2696c90](https://github.com/bit-cook/gpt-computer-assistant/commit/2696c90d976e749bbc95aba63781dd4776e6d5a2))
* Cultural Knowledge ([04da140](https://github.com/bit-cook/gpt-computer-assistant/commit/04da140174b58eddae4027361638ca134ed038ad))
* current_data optional, agent infers data source from notebook ([#575](https://github.com/bit-cook/gpt-computer-assistant/issues/575)) ([4c26d41](https://github.com/bit-cook/gpt-computer-assistant/commit/4c26d41b2af31e03dedb3157e3100721b44f6ccd))
* deep agent and pipeline ([78d4157](https://github.com/bit-cook/gpt-computer-assistant/commit/78d415732b9aafff49ad22bcc73c59d881cfb62d))
* deep agent and pipeline, bug fixing ([1c423de](https://github.com/bit-cook/gpt-computer-assistant/commit/1c423de710b23a643c5c2e92aa721a3d4e94868d))
* DeepAgent refactored and tool adding via Agent class added ([8325202](https://github.com/bit-cook/gpt-computer-assistant/commit/83252024709784a34c7826b838aff229489a62e2))
* Direct class for fast and simple model request ([ba0fcd0](https://github.com/bit-cook/gpt-computer-assistant/commit/ba0fcd0395c9da1027f88d5681f05fca272e33fc))
* discord interface, skills integration ([9e74474](https://github.com/bit-cook/gpt-computer-assistant/commit/9e74474fce808503039ed3ee21742adba8f7785e))
* docling loader, new tests ([658859f](https://github.com/bit-cook/gpt-computer-assistant/commit/658859f7f2af420c46d20f5ab192f3ec49918d1a))
* durable execution, ocr engine ([22cf750](https://github.com/bit-cook/gpt-computer-assistant/commit/22cf7507fcee7afbefbb60536bf113b8ebb5bfe3))
* enhance multi-agent execution with print method control ([38331e0](https://github.com/bit-cook/gpt-computer-assistant/commit/38331e0b1711e1759502fbaa3443c753abbb9cf1))
* enhance task management and pipeline logging ([fd83515](https://github.com/bit-cook/gpt-computer-assistant/commit/fd83515a3ffba75f130c0773a5582cfa8e3c2e9a))
* Enhance telemetry and logging features with comprehensive documentation and tests ([a1e5947](https://github.com/bit-cook/gpt-computer-assistant/commit/a1e5947a1e3449135362c12be433909dd47c2121))
* enhanced input type for anthropic, Team printing logic same as Agent ([634f676](https://github.com/bit-cook/gpt-computer-assistant/commit/634f676b87a1871498cf367d9b86c0367ce50689))
* Expression Language for Upsonic ([5e21ddc](https://github.com/bit-cook/gpt-computer-assistant/commit/5e21ddc2ed19d4c96aa69eb643617e3adc2b5d84))
* heartbeat feature for AutonomousAgent in interfaces ([f21cd61](https://github.com/bit-cook/gpt-computer-assistant/commit/f21cd614e06a2736145a8a00a7287acc8638c573))
* implement asynchronous OCR processing and add new document conversion layer ([825d043](https://github.com/bit-cook/gpt-computer-assistant/commit/825d04344f8964d568ea05cf1b684c0de6ebd183))
* implement asynchronous OCR processing and add new document conversion layer ([53755db](https://github.com/bit-cook/gpt-computer-assistant/commit/53755db119d81c5f428cc4eb79491b2d4698230c))
* implement de-anonymization in CallManagementStep for improved output clarity ([3204adc](https://github.com/bit-cook/gpt-computer-assistant/commit/3204adc8d8284b1ad0338cada84ef37bda8e20fa))
* implement persistent background event loop for async execution in Agent ([f57949d](https://github.com/bit-cook/gpt-computer-assistant/commit/f57949d42f37e86f5c66f9b0471b873cfbcb115a))
* install command and fasten cli ([9e4deee](https://github.com/bit-cook/gpt-computer-assistant/commit/9e4deeeacdcaca7143aaa69ab6b8828cb0b20da5))
* interface, tool handling refactor ([9f3dc89](https://github.com/bit-cook/gpt-computer-assistant/commit/9f3dc8981615584d584b043b0d444e8d0de29f2e))
* interfaces added (whatsapp, gmail and slack) ([c17cafe](https://github.com/bit-cook/gpt-computer-assistant/commit/c17cafebbbefcc7b492766d7e1ee70c8b8ea3563))
* KnowledgeBase as tool feature added ([f52add7](https://github.com/bit-cook/gpt-computer-assistant/commit/f52add7a95e09bbfac8a21fb8e369ea9e17046c0))
* mail interface ([4ac2cfb](https://github.com/bit-cook/gpt-computer-assistant/commit/4ac2cfb2a38a1630eca70d5fcea3e14259030718))
* mail interface ([8f6b378](https://github.com/bit-cook/gpt-computer-assistant/commit/8f6b3786d95ea000cd6f6c1d5d0e8e4a0798d30b))
* mem0 integration, refactor attachment attribute ([a44e16c](https://github.com/bit-cook/gpt-computer-assistant/commit/a44e16cd9f02598bfc1597bba481f6a3eb0dc59b))
* multiple policy handling ([218854c](https://github.com/bit-cook/gpt-computer-assistant/commit/218854ce082615dfc02b1a3209dbb9c267fd2a57))
* new model providers ([2db6a34](https://github.com/bit-cook/gpt-computer-assistant/commit/2db6a34a87258b58cc48c5aaad57e411d28d1e44))
* new model setting classes for models ([a9ff883](https://github.com/bit-cook/gpt-computer-assistant/commit/a9ff8834a36694e81c55ffa72a1aaa0675145eec))
* new model setting classes for models ([78946cd](https://github.com/bit-cook/gpt-computer-assistant/commit/78946cd27b14c1e7e56c62117024493864ecf24e))
* new policies, builtin tool handling, bug fixes ([c075fae](https://github.com/bit-cook/gpt-computer-assistant/commit/c075faef08fd2706f6cc794f52d2a43f2f6b0aff))
* OCR Enginer custom model support ([e058171](https://github.com/bit-cook/gpt-computer-assistant/commit/e058171ac74c6b0d189a3edced80181effdedbdb))
* OTel/Langfuse/Crawlee integration, model api updates, context manager fix ([8ea942f](https://github.com/bit-cook/gpt-computer-assistant/commit/8ea942fb1e45ea046174c6bf4bbe8b6b7d51dc4e))
* parameter support for apify tools ([5084a6a](https://github.com/bit-cook/gpt-computer-assistant/commit/5084a6ab4e742b4b447c1ea47b7b7d94bea13a8c))
* parameter support for apify tools ([de169d6](https://github.com/bit-cook/gpt-computer-assistant/commit/de169d66d6144fdf1ebf237b7d71ffc98047c110))
* pdfplumber loader and its tests ([0cb851a](https://github.com/bit-cook/gpt-computer-assistant/commit/0cb851ae9d31881373cb4b54dca017aefbbe2d60))
* Prints improved for import errors ([89a4c8b](https://github.com/bit-cook/gpt-computer-assistant/commit/89a4c8b938eaf2ae6070e8ae1bd65b5f918b4db2))
* pymupdf loader ([807b139](https://github.com/bit-cook/gpt-computer-assistant/commit/807b1394b0020ffa4d946a6687fc9715299c6981))
* reasoning and thinking attributes mapping ([96caa23](https://github.com/bit-cook/gpt-computer-assistant/commit/96caa237bc1b670e5c8173419aa38d4b40bb802f))
* reasoning and thinking attributes mapping ([66ca2c5](https://github.com/bit-cook/gpt-computer-assistant/commit/66ca2c56440d8f122a38e5e2622c338760945443))
* rename AppliedScientist research_paper to research_source ([#570](https://github.com/bit-cook/gpt-computer-assistant/issues/570)) ([c4c3034](https://github.com/bit-cook/gpt-computer-assistant/commit/c4c30349f5004da8b6cd8f840711485959bf21c4))
* Safety policy for tools added ([8e13503](https://github.com/bit-cook/gpt-computer-assistant/commit/8e13503f1321538f673160d344836803282cfe38))
* Simulation feature ([c55c496](https://github.com/bit-cook/gpt-computer-assistant/commit/c55c49651e730cb4b1039aa4bc5a687c85351932))
* state graph, recursive tool handling for streaming logic ([7ccd9e8](https://github.com/bit-cook/gpt-computer-assistant/commit/7ccd9e813a64ac5b7eda25a4311922ee90e952f7))
* state graph, recursive tool handling for streaming logic ([b6ffaee](https://github.com/bit-cook/gpt-computer-assistant/commit/b6ffaee3c22741cee0ef17ec3818312597a5d789))
* supermemory storage, agent metrics ([bd53edf](https://github.com/bit-cook/gpt-computer-assistant/commit/bd53edff8a5ec3f36b3fd7a89190b02db299bd44))
* supermemory storage, agent metrics ([cc90b22](https://github.com/bit-cook/gpt-computer-assistant/commit/cc90b22ed75f58273b9024bb10044c8c982f1f18))
* Team/interface streaming mode ([2a2b9b7](https://github.com/bit-cook/gpt-computer-assistant/commit/2a2b9b7b52aeb971958739f30fe8add9a325dbe2))
* telegram interface, chat/task modes for interfaces ([8d456e2](https://github.com/bit-cook/gpt-computer-assistant/commit/8d456e21c465967fc09c9597a1b28aad0f2f4dcb))
* telegram interface, chat/task modes for interfaces ([f056626](https://github.com/bit-cook/gpt-computer-assistant/commit/f056626e64eda5bca61b96d39dc09b55fba919b6))
* test file for pymupdf ([584b22e](https://github.com/bit-cook/gpt-computer-assistant/commit/584b22e29bbafda96821d66bbddfc0efc579b268))
* tests for new policies ([ab0d215](https://github.com/bit-cook/gpt-computer-assistant/commit/ab0d215269e9c83048b523f82d4cddefc1f3f383))
* version 0.69.0 ([4c81605](https://github.com/bit-cook/gpt-computer-assistant/commit/4c81605d266ba922b8ce92eb48b996c4ae127166))
* version 0.69.0 ([2e0881d](https://github.com/bit-cook/gpt-computer-assistant/commit/2e0881dda05aaaa4005497c5c479b24d70d2fad8))
* workspace feature, autonomous agent ([855053f](https://github.com/bit-cook/gpt-computer-assistant/commit/855053fce0662227d9246268ff4a0844b481a305))
* zip command ([05a2ad1](https://github.com/bit-cook/gpt-computer-assistant/commit/05a2ad1da189ad452fc68682cd887259396527cd))


### Bug Fixes

* add 'gemini' provider support in model inference ([d7f9ada](https://github.com/bit-cook/gpt-computer-assistant/commit/d7f9ada9c39589f35063d2a1ab1c85baa89daddd))
* add some missings ([763a1b4](https://github.com/bit-cook/gpt-computer-assistant/commit/763a1b4e78a75473038fb7090f6a1b7010b2cbd2))
* add threading for initializing ocr engines preventing multiple download ([7f58155](https://github.com/bit-cook/gpt-computer-assistant/commit/7f58155c5d45271c6dd1c78f209456fb4061504e))
* add threading for initializing ocr engines preventing multiple download ([4dfca6c](https://github.com/bit-cook/gpt-computer-assistant/commit/4dfca6c98848c95aa56256b43b5be1bc78e575ba))
* align asqav integration with actual SDK API ([d31a783](https://github.com/bit-cook/gpt-computer-assistant/commit/d31a7838248d72e92a454a626f5fd3d5d873f14d))
* apify tool function schema fix ([6bf994d](https://github.com/bit-cook/gpt-computer-assistant/commit/6bf994d180a6360970447eff00963d9eab0a6f7a))
* apify tool function schema fix ([274ecb2](https://github.com/bit-cook/gpt-computer-assistant/commit/274ecb2dfe56275790b264973c8813da11cfe8f3))
* asqav integration bugs ([0e4f371](https://github.com/bit-cook/gpt-computer-assistant/commit/0e4f371d58fbea99bf69e58b84a844418593c156))
* Backward compatibility for Azure OpenAI ([d0d65e2](https://github.com/bit-cook/gpt-computer-assistant/commit/d0d65e28fee5889c7e160d6f7ce7224eccb09ea3))
* Backward compatiblity for LLM_MODEL_KEY and bypass_llm_model ([143937f](https://github.com/bit-cook/gpt-computer-assistant/commit/143937ff6a74d4784587f49aed074e2e6270c79b))
* bedroc profile creation fix ([a45988d](https://github.com/bit-cook/gpt-computer-assistant/commit/a45988d3212e5c2942bf41c315db0bbf1af84fcd))
* bedroc profile creation fix ([c167f1a](https://github.com/bit-cook/gpt-computer-assistant/commit/c167f1a3ce1425cb94d969cc0517883d5035db90))
* bug fixing ([bd5f5c4](https://github.com/bit-cook/gpt-computer-assistant/commit/bd5f5c4af198af3a47df9cefc4610af2f6292ed9))
* change Agents.md to AGENTS.md for workflow set. fix greeting logic for interfaces ([ec238f4](https://github.com/bit-cook/gpt-computer-assistant/commit/ec238f4b4d5d3051a4fdf4a2a4b38c501b4fd134))
* chat streaming fix ([cfe8893](https://github.com/bit-cook/gpt-computer-assistant/commit/cfe8893a39db980fc862fbebae4b9bc0eb00c386))
* **chat,messages:** tolerate trailing junk in tool args and reset task on retry ([#597](https://github.com/bit-cook/gpt-computer-assistant/issues/597)) ([#598](https://github.com/bit-cook/gpt-computer-assistant/issues/598)) ([12f3ac2](https://github.com/bit-cook/gpt-computer-assistant/commit/12f3ac2e2f346b3174f459f01af7e218e72b4d93))
* **ci:** refresh uv.lock at release and update release-please config ([2d9324a](https://github.com/bit-cook/gpt-computer-assistant/commit/2d9324ad1f20f1d6f48dd58abd05ae6e12c9f196))
* **ci:** use uv publish instead of pypa action ([f0277e8](https://github.com/bit-cook/gpt-computer-assistant/commit/f0277e8292f0f1484bdfb8933787a85bcc9d73a1))
* company name and other company releated attributes on agent object fixed ([640d6d1](https://github.com/bit-cook/gpt-computer-assistant/commit/640d6d133745d0a8dd33cb30c256abc4578995fa))
* conftest.py fix ([3bdeb6a](https://github.com/bit-cook/gpt-computer-assistant/commit/3bdeb6ae67609b7b721d7eec403b74abe47c8211))
* correct YFinanceTools import and update notebook cells ([f669f12](https://github.com/bit-cook/gpt-computer-assistant/commit/f669f12ea19e23163af80fdb747ba63128e8054a))
* correct YFinanceTools import and update notebook cells ([e5ff625](https://github.com/bit-cook/gpt-computer-assistant/commit/e5ff625da096dc4458bdbce8ca8d6286e4c9eef3))
* correct YFinanceTools import and update notebook cells ([4f84b56](https://github.com/bit-cook/gpt-computer-assistant/commit/4f84b56a44f2f165a175ef9037cfa2e01e149c84))
* dependency conflict fix ([b96fd10](https://github.com/bit-cook/gpt-computer-assistant/commit/b96fd10c74c5a4c336c4bb396828209d79549f7d))
* dependency fix ([bf7e28f](https://github.com/bit-cook/gpt-computer-assistant/commit/bf7e28f7c6e0dc0f81e053f0212a5dd626ccd8da))
* dependency fix for unittests ([c39cca0](https://github.com/bit-cook/gpt-computer-assistant/commit/c39cca07d3c939043d029257d03211a50f1c16a6))
* dependency migration, faiss/pgvector vectordb smoke tests, task metric fix when its Direct class ([19d1a3d](https://github.com/bit-cook/gpt-computer-assistant/commit/19d1a3d415cac9d87b5f81aae2ece9b14dae73ec))
* env variable fix for bedrock ([a92a9fe](https://github.com/bit-cook/gpt-computer-assistant/commit/a92a9fee1a0a2a20e20bac5e83fa2156d759710c))
* fix Agent printing ([4af4717](https://github.com/bit-cook/gpt-computer-assistant/commit/4af4717ef8f9ae9a03cc97ee3853b5c94547d82e))
* fix Agent printing ([3087e9b](https://github.com/bit-cook/gpt-computer-assistant/commit/3087e9b88bc4c236f60355ce8498bd6131869581))
* fix api key dependet unit test ([2af25d0](https://github.com/bit-cook/gpt-computer-assistant/commit/2af25d04d4674e897a17a9292f065bd141c6bf5a))
* fix base64 method ([b4d6dd7](https://github.com/bit-cook/gpt-computer-assistant/commit/b4d6dd7f198425fafef21607aa58f5b86ff59f6f))
* fix bedrock provider ([6629d46](https://github.com/bit-cook/gpt-computer-assistant/commit/6629d46a68306480b5d124b77e0648729d924b5b))
* fix bedrock provider ([3f28aa0](https://github.com/bit-cook/gpt-computer-assistant/commit/3f28aa015cd23b2aa42465bb0ab06514fadd9807))
* fix call manager unit test ([db89d46](https://github.com/bit-cook/gpt-computer-assistant/commit/db89d46857ca3fe1ed51df387cec3b4519a74e96))
* fix ContextManager class based on the changes on KnowledgeBase class ([c6c56c4](https://github.com/bit-cook/gpt-computer-assistant/commit/c6c56c4dfb22ccafca532cfa1cdab5a4c72ae569))
* fix dependency conflict ([39c69c3](https://github.com/bit-cook/gpt-computer-assistant/commit/39c69c3549e13567756adb457da8b0aa16200b4c))
* fix dependency conflict between cloudpickle and snowflake-snowpark-python ([61f008b](https://github.com/bit-cook/gpt-computer-assistant/commit/61f008bf71957e01eba8e3d72ee38c0f2f59e45e))
* fix docstring of search tool from knowledgebase, mcp closing met… ([2283cfb](https://github.com/bit-cook/gpt-computer-assistant/commit/2283cfb6f7035ad9b6af8f1d09be8e6055a226ee))
* fix docstring of search tool from knowledgebase, mcp closing method adding added via Task class ([1d30e17](https://github.com/bit-cook/gpt-computer-assistant/commit/1d30e17edaa4daa431092004ef640e7ad977b35b))
* fix empty system prompt ([fd9e7ee](https://github.com/bit-cook/gpt-computer-assistant/commit/fd9e7eed693118c42b0e378f0247a68e5294506d))
* fix empty system prompt ([40c4ba0](https://github.com/bit-cook/gpt-computer-assistant/commit/40c4ba0afb6980ffcb62d32cee065a361013b8bf))
* fix failed otel test ([a7e6e25](https://github.com/bit-cook/gpt-computer-assistant/commit/a7e6e2534dc0dc6e12b85e81aeaf9b29a671fbf9))
* fix failed smoke test ([6203cb7](https://github.com/bit-cook/gpt-computer-assistant/commit/6203cb7cacaaf74ded6eeefc3e9ad32c7b58584b))
* fix firecrawl smoke test usage ([2e239b9](https://github.com/bit-cook/gpt-computer-assistant/commit/2e239b96055c4bade299087db2499ff305b14896))
* fix firecrawl tool attributes ([f525576](https://github.com/bit-cook/gpt-computer-assistant/commit/f525576762ba6cd1814ec0ab9bbf091f2e57f466))
* fix function calling parameters ([a60d349](https://github.com/bit-cook/gpt-computer-assistant/commit/a60d34951f52704b90c60239a37b01e06a8d2daf))
* fix github workflow ([cf6416c](https://github.com/bit-cook/gpt-computer-assistant/commit/cf6416c69f2bac06da46781022210525505d51fd))
* fix greeting logic in interfaces ([29aa168](https://github.com/bit-cook/gpt-computer-assistant/commit/29aa168cf4daa26ad5c205afd8b0016d05a3111a))
* fix knowledgebase unit test for 'query_knowledge_base' ([17a787a](https://github.com/bit-cook/gpt-computer-assistant/commit/17a787a01cd0b2ca815c05daad5dce986ab31c43))
* fix lazy importing of storage classes ([94bc1d8](https://github.com/bit-cook/gpt-computer-assistant/commit/94bc1d8302231ec5fb0de501fb6e9c422897239b))
* fix LLM usage tracking ([a621dca](https://github.com/bit-cook/gpt-computer-assistant/commit/a621dcab610baef1d945be6841421e0e072d947f))
* fix LLM usage tracking ([53125e1](https://github.com/bit-cook/gpt-computer-assistant/commit/53125e167acb6753937ab0f4b084db7902cba6f9))
* fix mcp smoke test cases ([e3c5cdc](https://github.com/bit-cook/gpt-computer-assistant/commit/e3c5cdc8a9294b7ec5b233a05f6d2da5cf622613))
* fix mem0 storage implementation and enhance tests ([ec0924b](https://github.com/bit-cook/gpt-computer-assistant/commit/ec0924b1e7ae3ba0bd7c9f45655b304e0ed146e5))
* fix memory error for streaming ([edbc6f2](https://github.com/bit-cook/gpt-computer-assistant/commit/edbc6f2c8bfa45376b6866fbcbe481790dffda32))
* fix milvus test stucking ([70c6b2d](https://github.com/bit-cook/gpt-computer-assistant/commit/70c6b2ddca65d6082bbf6b78542c090e0654e6c2))
* fix milvus unittest ([fc5279c](https://github.com/bit-cook/gpt-computer-assistant/commit/fc5279cf0110bf2cc923e1f7d59d791ba69c873d))
* fix nested f strings formatting for python 3.11 ([c754cdb](https://github.com/bit-cook/gpt-computer-assistant/commit/c754cdb6f7e05852b0e340f52c525fd4902df6d7))
* fix nested f strings formatting for python 3.11 ([3f5c5eb](https://github.com/bit-cook/gpt-computer-assistant/commit/3f5c5ebe9e1e721303625db15a699d7be5166825))
* fix normalizing model ids ([0b6a9f5](https://github.com/bit-cook/gpt-computer-assistant/commit/0b6a9f560e10c30ed19d0f13aadd2654c18202bc))
* fix normalizing model ids ([cd8b15a](https://github.com/bit-cook/gpt-computer-assistant/commit/cd8b15ab84a500c6b6e13bb0c83797378ced0427))
* fix package management ([dfca704](https://github.com/bit-cook/gpt-computer-assistant/commit/dfca7045d7fbcfaec192bcbcab5e02503681176f))
* fix package management and test github workflow ([f558fe4](https://github.com/bit-cook/gpt-computer-assistant/commit/f558fe41e9e9e4297472b234098364911dbbea23))
* fix package management and unit test workflow ([ea2b6bc](https://github.com/bit-cook/gpt-computer-assistant/commit/ea2b6bccc7345d13185421873d77f09b1b45e0da))
* fix price not found error ([8567e31](https://github.com/bit-cook/gpt-computer-assistant/commit/8567e31131df6b6f4583891d857f7e4cc039cbb6))
* fix profanity policy implementation ([6d6e9cc](https://github.com/bit-cook/gpt-computer-assistant/commit/6d6e9cc66dc38f64c10735167684d624a7a3f442))
* fix proper logic for custom api and model ([c8aa738](https://github.com/bit-cook/gpt-computer-assistant/commit/c8aa738535b629e2af256e56dfbafa9760a8f9de))
* fix pytest.ini ([ba2ca18](https://github.com/bit-cook/gpt-computer-assistant/commit/ba2ca18d525a66edd339ac446961d41da9da850f))
* fix retry and task error status collision ([bd071ac](https://github.com/bit-cook/gpt-computer-assistant/commit/bd071ac9209bee88784f75524568c0518287435f))
* fix retry and task error status collision ([2d8b245](https://github.com/bit-cook/gpt-computer-assistant/commit/2d8b2452610ea19759d4c8e2385c67a08340ad0c))
* fix run command not importing other files ([f4842f8](https://github.com/bit-cook/gpt-computer-assistant/commit/f4842f8c6938da618819ec9894107c08d7d1df36))
* fix run command not importing other files ([4499fe8](https://github.com/bit-cook/gpt-computer-assistant/commit/4499fe8695d6975f0eeb3609e06cde6d906036b4))
* fix smoke tests by using new printing usage ([9643a0c](https://github.com/bit-cook/gpt-computer-assistant/commit/9643a0cc0271a262b9696747b52f0998df5f7526))
* fix smoke tests by using new printing usage ([012878e](https://github.com/bit-cook/gpt-computer-assistant/commit/012878eaaa2e5f1a126f5fc901778e3956db25dc))
* fix some bugs and external tool call ([eab5e03](https://github.com/bit-cook/gpt-computer-assistant/commit/eab5e0389a640fc750983f6ede8844c227ec1c7a))
* fix state mutuation race condition and inconsistent default behavior ([70e9740](https://github.com/bit-cook/gpt-computer-assistant/commit/70e9740998fdf6b64d3244a9ea44da1f9fc83088))
* fix stream logic ([4c05bcf](https://github.com/bit-cook/gpt-computer-assistant/commit/4c05bcfa8e0d76a7fcd0e593e85d83fc48efe10b))
* fix stuck unit test ([b6504a3](https://github.com/bit-cook/gpt-computer-assistant/commit/b6504a31d52eb9458f4e94c6df47c25ba59465c8))
* fix test files ([b0b15c5](https://github.com/bit-cook/gpt-computer-assistant/commit/b0b15c5f8685933d8f3a3e6ab55bbbfa33786752))
* fix test for new architectures ([5db686e](https://github.com/bit-cook/gpt-computer-assistant/commit/5db686e8b6b157845dce342be0fd6290542c30ea))
* fix test workflow ([8af36a4](https://github.com/bit-cook/gpt-computer-assistant/commit/8af36a48cfb6cafb09291623c17373cf266f71c5))
* fix test workflow ([72cc1fb](https://github.com/bit-cook/gpt-computer-assistant/commit/72cc1fb9b0bd61462c08f2b7f286d456e60ac96f))
* fix tests and task ([0b43659](https://github.com/bit-cook/gpt-computer-assistant/commit/0b436593db2ac98f223e8218cd4a79b336f35935))
* fix tests for skill integration ([0100e10](https://github.com/bit-cook/gpt-computer-assistant/commit/0100e109919b7150b5a2790cc3c6634dc6d01830))
* fix tests for skill integration ([736bb3f](https://github.com/bit-cook/gpt-computer-assistant/commit/736bb3ff217154e9f94c7d1a0cfcfbcadf8b8adf))
* fix tests getting stuck ([b1977cd](https://github.com/bit-cook/gpt-computer-assistant/commit/b1977cd5884266f91b6bfcebe7d6c8c26d00b8d7))
* fix tests.yml ([29c371f](https://github.com/bit-cook/gpt-computer-assistant/commit/29c371f276151ef16cf2d4a036386f35cecd6645))
* fix the unit test v2 ([c68a899](https://github.com/bit-cook/gpt-computer-assistant/commit/c68a89987d2e665306061420df67598d92e83a03))
* fix total duration time tracking ([8838877](https://github.com/bit-cook/gpt-computer-assistant/commit/883887727139db0207c56114d2c7068dbe4d84ef))
* fix typing issues ([3ea957e](https://github.com/bit-cook/gpt-computer-assistant/commit/3ea957e66351fdad0973c242246d2195bca3b650))
* fix unit test ([05f365b](https://github.com/bit-cook/gpt-computer-assistant/commit/05f365bd075184b5e86cb55e237604843a76c4c5))
* fix unit test ([33215c3](https://github.com/bit-cook/gpt-computer-assistant/commit/33215c33f2881a0e61126785c660f2903715930f))
* fix unit test failings ([f4f0bb0](https://github.com/bit-cook/gpt-computer-assistant/commit/f4f0bb0550f049b79c859cc1d50094ab5e1b26d8))
* fix unit test for firecrawl ([e9fbc90](https://github.com/bit-cook/gpt-computer-assistant/commit/e9fbc9075f3ff48d8ac5f02669fd52c1bd8d2b28))
* fix unit test for requiring openai api key ([85ed454](https://github.com/bit-cook/gpt-computer-assistant/commit/85ed45449a1d68dcbede9e6ac989e5cacc03d24b))
* fix unit test run error ([33f03d2](https://github.com/bit-cook/gpt-computer-assistant/commit/33f03d2f0ef99ba5364f99b93c83a4972b7eec31))
* fix unit test usage ([3bbe888](https://github.com/bit-cook/gpt-computer-assistant/commit/3bbe888d220069f07ed4a6999fcfafb4e9262ba6))
* fix unit tests ([891ea90](https://github.com/bit-cook/gpt-computer-assistant/commit/891ea90b82a64d6bca1141297faf965b71edc4da))
* fix unit tests ([af1ff3d](https://github.com/bit-cook/gpt-computer-assistant/commit/af1ff3d943642db521ac8f5e26bc1af553a7b6cf))
* fix unit tests ([fec6ec7](https://github.com/bit-cook/gpt-computer-assistant/commit/fec6ec7704b55c892d58d300e6a554aae2f55379))
* fix unit tests ([69d6d60](https://github.com/bit-cook/gpt-computer-assistant/commit/69d6d609cfdaf6ab91879ce613ef9c91584770e6))
* fix unit tests ([22bfeae](https://github.com/bit-cook/gpt-computer-assistant/commit/22bfeaeed5505c71958f407838a9929bb1b45067))
* fix unit tests ([46d4803](https://github.com/bit-cook/gpt-computer-assistant/commit/46d48031d8bbeb19db1551b559dca930ba24f6d2))
* fix unit tests ([13e301c](https://github.com/bit-cook/gpt-computer-assistant/commit/13e301cb0c0c7f011e4b651fa9f2d9df37695bbb))
* fix unit tests ([4e14a2e](https://github.com/bit-cook/gpt-computer-assistant/commit/4e14a2ea20e4eea8c6c25094a4149fb80be3562d))
* fix unit tests ([22b7858](https://github.com/bit-cook/gpt-computer-assistant/commit/22b7858bf3f992caafb6c2090d357ceedb041492))
* fix unit tests for 3.12 ([f8c8cdb](https://github.com/bit-cook/gpt-computer-assistant/commit/f8c8cdb8bcabe57d1db6d87d34bf24129235711d))
* fix unit tests in github ([de7635c](https://github.com/bit-cook/gpt-computer-assistant/commit/de7635c7b9190b34cd50482fec8582b2758de655))
* fix wrong api usage and anthropic api usage for new versions ([b63bb99](https://github.com/bit-cook/gpt-computer-assistant/commit/b63bb9955b04d679ba680e2f5bfcbfd690ff60e1))
* fix wrong api usage and anthropic api usage for new versions ([#533](https://github.com/bit-cook/gpt-computer-assistant/issues/533)) ([a05e99b](https://github.com/bit-cook/gpt-computer-assistant/commit/a05e99b768819ec3353447de29894f00e625d522))
* fixing files for unittests ([f55fa95](https://github.com/bit-cook/gpt-computer-assistant/commit/f55fa95d3614469939b21c3d9693df5a3926428d))
* Fixing vectordbs ([cd5120c](https://github.com/bit-cook/gpt-computer-assistant/commit/cd5120c154c4c83adc25d1f07b2a1c8e5b329c0d))
* Improve smoke tests by adding timeout and simplifying task configurations ([777fdeb](https://github.com/bit-cook/gpt-computer-assistant/commit/777fdeb66bd59a0a641751eeccd99e93706888a4))
* json config data fix in 'upsonic init' command ([8c8195e](https://github.com/bit-cook/gpt-computer-assistant/commit/8c8195eff51ecbc6df6866c31ae366f603770bbe))
* llmlingua prompt compression api fix ([1e4bbde](https://github.com/bit-cook/gpt-computer-assistant/commit/1e4bbde95dadc42e2930d138f250160448736144))
* logging fix, memory error handling adding ([6fd5105](https://github.com/bit-cook/gpt-computer-assistant/commit/6fd510529e8af72697caf7e69fd053dd5a08fa7b))
* logging fix, memory error handling adding ([bbaf324](https://github.com/bit-cook/gpt-computer-assistant/commit/bbaf32471c26e82232099c52962f2e8a5d60d208))
* MCP call_tool fails for streamable-http and SSE transports ([e2095bd](https://github.com/bit-cook/gpt-computer-assistant/commit/e2095bd214783dbb10554a74339a112410e88d31))
* MCP call_tool fails for streamable-http and SSE transports ([66f181a](https://github.com/bit-cook/gpt-computer-assistant/commit/66f181a1ee73ef166c7abff56132d1cdcbb59398))
* moved smoke tests from unit_tests into smoke_tests ([1f94bfa](https://github.com/bit-cook/gpt-computer-assistant/commit/1f94bfaa0e809712cd7d66b5f4d8f00d060c1777))
* New Tracing and centralized logging system ([30b08b6](https://github.com/bit-cook/gpt-computer-assistant/commit/30b08b67ade4f7cdd9142b9119bfdae37063b7b0))
* notebook fixed ([aff5197](https://github.com/bit-cook/gpt-computer-assistant/commit/aff5197dc953757ae41a437f09ef63cdaf024b5d))
* prevent command injection in check_command_exists (CWE-78) ([520418c](https://github.com/bit-cook/gpt-computer-assistant/commit/520418c5a0afa14d4306cb6b5e370ca6e1effc31))
* prevent command injection in check_command_exists (CWE-78) ([110c633](https://github.com/bit-cook/gpt-computer-assistant/commit/110c633abd5d5263525ee77584d3c367f6084f6a))
* printing now depedent on fully 'debug' flag ([f85d062](https://github.com/bit-cook/gpt-computer-assistant/commit/f85d062ddbb45927997d3d7c9e3b2ad55c0804fc))
* Problem resolved on ollama usage with model as string ([9aeae51](https://github.com/bit-cook/gpt-computer-assistant/commit/9aeae511f49bf5f5931f5490031c9d51a5b282ab))
* remove fixed width from import error table ([3f7d967](https://github.com/bit-cook/gpt-computer-assistant/commit/3f7d9672a50b044f8dbdbcd9c9ad034d1dad6d6c))
* remove old version files ([afd9071](https://github.com/bit-cook/gpt-computer-assistant/commit/afd9071ffd0163fe111624615466015068e175f9))
* Resolved anonymization action logic ([#519](https://github.com/bit-cook/gpt-computer-assistant/issues/519)) ([5c60ede](https://github.com/bit-cook/gpt-computer-assistant/commit/5c60ede6f27a2fc84e6a508ee07e03c8e1f30afb))
* Resolved logging problem ([ca28976](https://github.com/bit-cook/gpt-computer-assistant/commit/ca28976aead7ba84bcad4bcfd5ed3c6d07c31d80))
* Resolved most of the errors of smoke tests ([f82dd89](https://github.com/bit-cook/gpt-computer-assistant/commit/f82dd8986748b2aa3c85566a59ea552674732c92))
* Resolved the deprecation warnings ([671a213](https://github.com/bit-cook/gpt-computer-assistant/commit/671a2134974b6dc7c8bb039274d67d212676c515))
* Resolved the deprecation warnings ([380957d](https://github.com/bit-cook/gpt-computer-assistant/commit/380957d1f05fe8117fd531734d9936d6c02a5747))
* reuploading uv.lock ([23d5a78](https://github.com/bit-cook/gpt-computer-assistant/commit/23d5a787ab9534a5fd4bca702716ffc20682bb98))
* set auotonmous agent print True as default ([00b699d](https://github.com/bit-cook/gpt-computer-assistant/commit/00b699dd7664d13235a718b961c4ff58a12ede84))
* set auotonmous agent print True as default ([#565](https://github.com/bit-cook/gpt-computer-assistant/issues/565)) ([5c855b1](https://github.com/bit-cook/gpt-computer-assistant/commit/5c855b1d787ead39871309fa1700420a0fdfacae))
* small fix on qdrant side, enhance qdrant smoke test ([5bd846d](https://github.com/bit-cook/gpt-computer-assistant/commit/5bd846d0527fbf7164b5fee5713973f6a04e20cc))
* small fix on qdrant side, enhance qdrant smoke test ([0c37772](https://github.com/bit-cook/gpt-computer-assistant/commit/0c377729cfea757c37b77c2f437c14909a10eb56))
* small fix on RAG side ([20fe2a4](https://github.com/bit-cook/gpt-computer-assistant/commit/20fe2a406678575839e0c94a37f6dd70dda89e05))
* system prompt setting up fix ([dc9a9d0](https://github.com/bit-cook/gpt-computer-assistant/commit/dc9a9d058dd12b6a735bc29c571743ad8db9d340))
* TECH-1625 centralized usage registry ([#602](https://github.com/bit-cook/gpt-computer-assistant/issues/602)) ([4dc6f60](https://github.com/bit-cook/gpt-computer-assistant/commit/4dc6f6028026adc5f6b2aed237e05d5dce65599b))
* **telemetry:** make Sentry strictly opt-in ([#583](https://github.com/bit-cook/gpt-computer-assistant/issues/583)) ([8365a22](https://github.com/bit-cook/gpt-computer-assistant/commit/8365a223ade3d9d20d12670b0693308e51e739bd))
* test fix ([b9965e8](https://github.com/bit-cook/gpt-computer-assistant/commit/b9965e8724f342bbd6b70e344357b38303effc17))
* test fix for python versions ([aee828d](https://github.com/bit-cook/gpt-computer-assistant/commit/aee828db9a56f677daddb2098ed3304b5fc17250))
* test fix, duplicate file remove ([363a8be](https://github.com/bit-cook/gpt-computer-assistant/commit/363a8be2f5755645c2e7dd978e48181cc6a50c35))
* test fixes ([961262b](https://github.com/bit-cook/gpt-computer-assistant/commit/961262b577004b36a441cc35529d4762d882452d))
* tool context parameter removing ([2560493](https://github.com/bit-cook/gpt-computer-assistant/commit/25604935016a2d044cfdc0fe296ce98036555c6e))
* tool unit test fix ([c58c920](https://github.com/bit-cook/gpt-computer-assistant/commit/c58c920e9c20e9119915ecf104ecf9ff11a02197))
* unit test fix ([7c8e39d](https://github.com/bit-cook/gpt-computer-assistant/commit/7c8e39d495105116a4b1ecbe58a829a240eba663))
* unit test fixes ([c2f956d](https://github.com/bit-cook/gpt-computer-assistant/commit/c2f956da32436ba42271d2bafeb66d947160d89f))
* unit tests fixing ([bacdaa9](https://github.com/bit-cook/gpt-computer-assistant/commit/bacdaa91b24512c6634ef6ce244ef91f1c6662d6))
* update dependency installation to use all extras ([fcb786e](https://github.com/bit-cook/gpt-computer-assistant/commit/fcb786e9769fd4df232ec45f440de6926f9562f1))
* update import paths to remove 'src' prefix in test_embedding_providers.py ([0e552b2](https://github.com/bit-cook/gpt-computer-assistant/commit/0e552b2b02caeb247ed6230c2e7f7dea7be82f24))
* update OCR prompt template in DeepSeekOllamaOCR class ([9f19b05](https://github.com/bit-cook/gpt-computer-assistant/commit/9f19b05a85b44921986b546adf27a4da77ab5628))
* Update project version to 0.63.1 ([3239b33](https://github.com/bit-cook/gpt-computer-assistant/commit/3239b3365e7b1f44a1da6f74fd0f96f3e8f8ad9b))
* Update project version to 0.64.1 in pyproject.toml and uv.lock ([22bf9da](https://github.com/bit-cook/gpt-computer-assistant/commit/22bf9da4670ec256d894d9d5d793e0bd4d10abf9))
* Update Sentry logging integration to capture INFO+ level logs and remove unnecessary breadcrumbs ([ffe1be8](https://github.com/bit-cook/gpt-computer-assistant/commit/ffe1be87714efc218c2e045db1874c03e14a549f))
* update version to 0.65.0 in pyproject.toml and uv.lock ([ade3062](https://github.com/bit-cook/gpt-computer-assistant/commit/ade30622502811733a24646758befa38e7d39549))
* vectordb init fix ([495d5e2](https://github.com/bit-cook/gpt-computer-assistant/commit/495d5e205f438b956da9617d0b977bc6f58ab27e))
* version fix ([d0035a1](https://github.com/bit-cook/gpt-computer-assistant/commit/d0035a123ea940fa892bdac8d57d2e842c73477b))
* version fix ([cc93984](https://github.com/bit-cook/gpt-computer-assistant/commit/cc93984aca0b819fbe0cf86d1f21fff587e3b95d))


### Documentation

* add banner image to README ([eaa341c](https://github.com/bit-cook/gpt-computer-assistant/commit/eaa341c9463679309e123becd704b638acaa6d0e))
* add SECURITY.md with responsible disclosure policy ([655c4d3](https://github.com/bit-cook/gpt-computer-assistant/commit/655c4d3037df177e801c01defaf5be52344f9dfb))
* add SECURITY.md with responsible disclosure policy ([eca02d4](https://github.com/bit-cook/gpt-computer-assistant/commit/eca02d43ac8fb48b5ed4fe00433548d8c34c70bc))
* clarify format and field rules in SKILL.md for progress tracking ([90d2256](https://github.com/bit-cook/gpt-computer-assistant/commit/90d2256cfb1b47753bc8c051a4d602d2c2680f33))
* **community:** add code of conduct ([101f031](https://github.com/bit-cook/gpt-computer-assistant/commit/101f0313b0ddb96cd4078354879b2ff57005db29))
* **community:** add code of conduct ([cd0b144](https://github.com/bit-cook/gpt-computer-assistant/commit/cd0b144a3c3f545338017a9397c6b4cfc26a60a4))
* fix broken links in README ([ae94a8a](https://github.com/bit-cook/gpt-computer-assistant/commit/ae94a8a2e69d78e2e25a6c7f15c373b5897a7120))
* fix broken links in README ([cb9994e](https://github.com/bit-cook/gpt-computer-assistant/commit/cb9994ec3e6d8af0395c2fd926a30b59ea92f8c8))
* fix Cowork capitalization per review ([270cb48](https://github.com/bit-cook/gpt-computer-assistant/commit/270cb482570724f95ae3d77462b2b6917336793c))
* fix test command in CONTRIBUTING.md to use uv run ([#520](https://github.com/bit-cook/gpt-computer-assistant/issues/520)) ([69b54a0](https://github.com/bit-cook/gpt-computer-assistant/commit/69b54a09a2e135da584d6a9f8f47509dc884f994))
* improve developer onboarding flow and add infrastructure section ([#509](https://github.com/bit-cook/gpt-computer-assistant/issues/509)) ([44901e8](https://github.com/bit-cook/gpt-computer-assistant/commit/44901e8f1ee3be28bf4ea9c5ac13b38420fe79c2))
* refactor README to follow open-source standards ([38e5cc8](https://github.com/bit-cook/gpt-computer-assistant/commit/38e5cc823b991855cea1940989dc47cdfb408d8c))
* refactor README to follow open-source standards ([df52504](https://github.com/bit-cook/gpt-computer-assistant/commit/df52504eabcce69a79194b84a7e7875869794af9))
* restructure README around autonomous agents ([f8a4887](https://github.com/bit-cook/gpt-computer-assistant/commit/f8a48875982bc0393526a0b35a7a93ffaaec6935))
* restructure README around autonomous agents ([29d2b56](https://github.com/bit-cook/gpt-computer-assistant/commit/29d2b5676f5fc3e49f86d40c096f78f10a8c9fe9))
* translate benchmarks QUICKSTART.md to English ([e4f8859](https://github.com/bit-cook/gpt-computer-assistant/commit/e4f8859a92d7148c9cc341bc486b5969b868680d))
* translate benchmarks QUICKSTART.md to English ([f66145a](https://github.com/bit-cook/gpt-computer-assistant/commit/f66145a9f15975df7210f9faab177375dfe5fe05))
* update README content and examples ([#535](https://github.com/bit-cook/gpt-computer-assistant/issues/535)) ([2dbedb3](https://github.com/bit-cook/gpt-computer-assistant/commit/2dbedb30fd3fa18e55f638383dbec567d0ddce90))
